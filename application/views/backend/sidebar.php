        <aside class="left-sidebar bg-light text-light">
            <!-- Sidebar scroll-->
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <?php } else { ?>
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-building-o"></i><span class="hide-menu">Company </span></a>
                                <ul aria-expanded="false" class="collapse">
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Employees </span></a>
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>employee/Disciplinary">Disciplinary/Punishment </a></li>
                                    <li><a href="<?php echo base_url(); ?>employee/Inactive_Employee">Inactive Employe </a></li>
                                </ul>
                            </li>
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-briefcase-check"></i><span class="hide-menu">Seminar/Conference </span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo base_url(); ?>Projects/All_Projects">Projects </a></li>
                                    <li><a href="<?php echo base_url(); ?>Projects/All_Tasks"> Task List </a></li>
                            ...
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-rocket"></i><span class="hide-menu">Office Assets </span></a>
                                <ul aria-expanded="false" class="collapse">
