                                    ...
                                    <?php foreach ($tasks as $value) : ?>
                                        <tr>
                                            ...
                                            <!--                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a onclick="alert('Are you sure want to delet this Value?')" href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light TasksDelet" data-id="<?php #echo $value->id 
